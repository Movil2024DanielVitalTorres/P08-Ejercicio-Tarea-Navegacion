package net.iessochoa.danielvitaltorres.tareasv01.data.db.entities
...
// Facilita la búsqueda en un arrayList
        override fun equals(other: Any?): Boolean {
            return (other is Tarea) && (this.idContador == other?.id)
        }
    ...
    constructor(
        ...
        descripcion: String) : this(
        generateId(), categoria, prioridad,
        img, pagado, estado, valoracionCliente, tecnico, descripcion) {}
